      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-3xl p-8 space-y-6"
            style={{ background: 'rgba(14,11,28,0.80)', border: '1px solid rgba(201,161,74,0.15)', backdropFilter: 'blur(20px)' }}>
            ...
            <div className="flex items-center gap-5">
              <div className="relative">
                ...
                <label className="absolute -bottom-2 -right-2 w-7 h-7 rounded-lg flex items-center justify-center cursor-pointer transition-all"
                  style={{ background: 'linear-gradient(135deg, hsl(42,70%,65%), hsl(45,85%,48%))', boxShadow: '0 4px 12px rgba(0,0,0,0.4)' }}>
            ...
            <motion.button onClick={handleSave} disabled={saving} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
              ...
              style={{ background: 'linear-gradient(135deg, hsl(42,70%,65%), hsl(45,85%,48%))', boxShadow: '0 8px 30px hsl(258,90%,66%,0.25)' }}>
