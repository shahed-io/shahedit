...
const emojiColors: Record<string, { bg: string; border: string; glow: string; badge: string }> = {
  "💻": { bg: "rgba(201,161,74,0.10)", border: "rgba(201,161,74,0.25)", glow: "rgba(201,161,74,0.15)", badge: "rgba(201,161,74,0.15)" },
  "📱": { bg: "rgba(59,130,246,0.10)", border: "rgba(59,130,246,0.25)", glow: "rgba(59,130,246,0.15)", badge: "rgba(59,130,246,0.15)" },
  "🎨": { bg: "rgba(244,215,122,0.10)", border: "rgba(244,215,122,0.25)", glow: "rgba(244,215,122,0.15)", badge: "rgba(244,215,122,0.15)" },
  "📊": { bg: "rgba(244,215,122,0.10)", border: "rgba(244,215,122,0.25)", glow: "rgba(244,215,122,0.15)", badge: "rgba(244,215,122,0.15)" },
...
const defaultColors = { bg: "rgba(201,161,74,0.10)", border: "rgba(201,161,74,0.25)", glow: "rgba(201,161,74,0.15)", badge: "rgba(201,161,74,0.15)" };
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                style={{ background: 'linear-gradient(135deg, hsl(42,70%,60%), hsl(45,85%,48%))' }}
              >
