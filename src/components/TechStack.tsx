...
import { techSlug } from "@/pages/TechDetailsPage";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-[hsl(320,90%,68%)] text-sm font-semibold mb-9 inline-flex items-center gap-2">
              <Sparkles size={14} /> যেকোনো technology এর নামে click করুন — বিস্তারিত page এ যাবেন
            </p>
            ...
            {techs.map((tech, i) => (
              ...
              >
                <Link
                  ...
                  style={{ background: `${tech.color}10`, border: `1px solid ${tech.color}25`, display: "flex" }}
                >
