...
const floatingIcons = [
  { icon: Code2, x: "10%", y: "20%", delay: 0, color: "hsl(42,70%,65%)" },
  { icon: Globe, x: "85%", y: "15%", delay: 0.5, color: "hsl(45,85%,48%)" },
...
const HeroBanner = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[700px] flex items-center">
      {/* Background layers */}
      <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, hsl(220,42%,5%) 0%, hsl(258,30%,8%) 50%, hsl(240,22%,4%) 100%)' }} />

      {/* Cross grid */}
      <div className="absolute inset-0 cross-grid opacity-60" />

      {/* Big glowing orbs */}
      <div className="absolute -top-32 -left-32 w-[700px] h-[700px] rounded-full float-anim" style={{ background: 'radial-gradient(circle, hsl(42,70%,65%) 0%, transparent 65%)', filter: 'blur(100px)', opacity: 0.18, animationDuration: '8s' }} />
      <div className="absolute -top-20 right-[5%] w-[500px] h-[500px] rounded-full float-anim" style={{ background: 'radial-gradient(circle, hsl(45,85%,48%) 0%, transparent 65%)', filter: 'blur(90px)', opacity: 0.13, animationDelay: '3s', animationDuration: '10s' }} />
      ...
      {/* Scan line */}
      <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 4px, rgba(201,161,74,0.012) 4px, rgba(201,161,74,0.012) 5px)' }} />
        ...
        <div className="grid lg:grid-cols-[1.3fr_1fr] gap-12 items-center">
          ...
          <div>
            <motion.div
              ...
              style={{ background: 'rgba(201,161,74,0.10)', borderColor: 'rgba(201,161,74,0.30)', color: 'hsl(42,70%,80%)' }}
            >
            ...
            >
              ...
              <span
                ...
                style={{ backgroundImage: 'linear-gradient(90deg, hsl(42,70%,75%), hsl(45,85%,55%), hsl(315,80%,70%), hsl(42,70%,75%))', backgroundSize: '300% 100%' }}
              >
                Digital Empire
              </span>
            </motion.h1>
            ...
            >
              <Link to="/get-quote">
                <motion.button
                  ...
                  style={{ background: 'linear-gradient(135deg, hsl(42,70%,65%), hsl(45,85%,45%))', boxShadow: '0 6px 30px rgba(201,161,74,0.45), 0 0 60px rgba(201,161,74,0.15)' }}
                >
          ...
          <div className="hidden lg:flex flex-col gap-5">
            ...
            <motion.div
              ...
              style={{ background: 'rgba(201,161,74,0.08)', border: '1px solid rgba(201,161,74,0.22)', backdropFilter: 'blur(16px)' }}
            >
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <div key={item.label} className="flex-1 rounded-xl p-3 text-center"
                    style={{ background: 'rgba(201,161,74,0.12)', border: '1px solid rgba(201,161,74,0.20)' }}>
            ...
            {/* Two info cards */}
            {[
              { tag: "🚀 Featured", title: "Web Development", desc: "Custom websites that convert visitors into customers", color: "hsl(42,70%,65%)" },
