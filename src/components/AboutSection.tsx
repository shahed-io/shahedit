      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }}>
            ...
            <div className="w-20 h-1 rounded-full mb-7" style={{ background: 'linear-gradient(90deg, hsl(185,100%,48%), hsl(258,90%,66%))' }} />
            ...
            <Link to="/about">
              <motion.button
                ...
                style={{ background: 'linear-gradient(135deg, hsl(258,90%,66%), hsl(185,100%,45%))', boxShadow: '0 6px 25px rgba(139,92,246,0.40)' }}
              >
