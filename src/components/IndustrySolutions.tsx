...
const solutions = [
  { icon: ShoppingCart, title: "Ecommerce", desc: "Powerful online store platforms for growth.", color: "hsl(258,90%,66%)", glow: "rgba(139,92,246,0.7)", border: "rgba(139,92,246,0.30)" },
  { icon: UtensilsCrossed, title: "Restaurant", desc: "Digital menus & ordering management.", color: "hsl(25,95%,60%)", glow: "rgba(249,115,22,0.7)", border: "rgba(249,115,22,0.28)" },
  { icon: Building2, title: "ERP Systems", desc: "Integrated management for business ops.", color: "hsl(270,80%,65%)", glow: "rgba(147,51,234,0.7)", border: "rgba(147,51,234,0.28)" },
  { icon: Monitor, title: "POS Solutions", desc: "Fast & reliable point-of-sale systems.", color: "hsl(185,100%,50%)", glow: "rgba(0,188,212,0.7)", border: "rgba(0,188,212,0.28)" },
  { icon: Ticket, title: "Ticketing", desc: "Booking, reservation & event tools.", color: "hsl(315,80%,65%)", glow: "rgba(236,72,153,0.7)", border: "rgba(236,72,153,0.28)" },
  { icon: FileText, title: "Content CMS", desc: "Custom blogs & content management.", color: "hsl(155,70%,45%)", glow: "rgba(34,197,94,0.7)", border: "rgba(34,197,94,0.28)" },
  { icon: Settings, title: "Management", desc: "Bespoke workflow optimization tools.", color: "hsl(45,93%,58%)", glow: "rgba(234,179,8,0.7)", border: "rgba(234,179,8,0.28)" },
  { icon: Smartphone, title: "Mobile Apps", desc: "iOS & Android high-performance apps.", color: "hsl(210,100%,62%)", glow: "rgba(59,130,246,0.7)", border: "rgba(59,130,246,0.28)" },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {solutions.map((sol, i) => (
            <SpotlightCard
              ...
              className="group cursor-pointer overflow-hidden rounded-2xl p-6"
              style={{
