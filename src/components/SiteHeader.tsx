...
import logoAsset from "@/assets/shahed-it-logo-v2.webp.asset.json";
    ...
    >
      ...
      >
        ...
        <div className="container mx-auto px-2.5 sm:px-3 md:px-4 lg:px-6 py-1.5 sm:py-2 md:py-3 flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-5 relative min-w-0">
          ...
          >
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }} className="flex items-center group min-w-0">
              <img
                src={logoUrl}
