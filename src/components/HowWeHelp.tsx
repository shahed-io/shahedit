  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full"
        style={{ background: 'radial-gradient(circle, hsl(185,100%,48%) 0%, transparent 65%)', filter: 'blur(120px)', opacity: 0.07 }} />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <div className="mt-5 mx-auto w-20 h-1 rounded-full" style={{ background: 'linear-gradient(90deg, hsl(258,90%,66%), hsl(185,100%,48%))' }} />
        </motion.div>
