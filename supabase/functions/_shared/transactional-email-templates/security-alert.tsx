...
const Email = (p: Props) => (
  <Layout
    ...
    intro={`প্রিয় ${p.name ?? 'গ্রাহক'}, আপনার একাউন্টে একটি নিরাপত্তা সংক্রান্ত ঘটনা পাওয়া গেছে।`}
    paragraphs={[`ধরন: ${p.alertType ?? 'সন্দেহজনক কাজ'}`, p.details ?? 'অনুগ্রহ করে আপনার পাসওয়ার্ড পরিবর্তন করুন এবং 2FA চালু করুন।']}
    
    ctaLabel={'এখনই একাউন্ট সুরক্ষিত করুন'}
